...
print(tables, 'does this have value?')
...
def upgrade():
    ...
    if 'workflowpipeline' not in tables:
        op.create_table(
            'workflowpipeline',
            sa.Column('id', sa.Integer(), nullable=False),
            sa.Column('uuid', sa.String(length=32), server_default='', nullable=False),
    ...
    if 'pipelinerunartifact' not in tables:
        op.create_table(
            'pipelinerunartifact',
            sa.Column('id', sa.Integer(), nullable=False),
            sa.Column('uuid', sa.String(length=32), server_default='', nullable=False),
    ...
    if 'pipelineruninput' not in tables:
        op.create_table(
            'pipelineruninput',
            sa.Column('id', sa.Integer(), nullable=False),
            sa.Column('uuid', sa.String(length=32), server_default='', nullable=False),
    ...
    if 'pipelinerunstate' not in tables:
        op.create_table(
            'pipelinerunstate',
            sa.Column('id', sa.Integer(), nullable=False),
            sa.Column('uuid', sa.String(length=32), server_default='', nullable=False),
    ...
    if 'workflowpipelinedependency' not in tables:
        op.create_table(
    ...
    if 'workflowpipelinerun' not in tables:
        op.create_table(
            'workflowpipelinerun',
            sa.Column('id', sa.Integer(), nullable=False),
            sa.Column('uuid', sa.String(length=32), server_default='', nullable=False),
    ...
    if 'workflowrunstate' not in tables:
        op.create_table(
            'workflowrunstate',
            sa.Column('id', sa.Integer(), nullable=False),
            sa.Column('uuid', sa.String(length=32), server_default='', nullable=False),
